...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function openChat(group) {
        ...
        chatAvatar.textContent = group.name.substring(0, 2).toUpperCase();
    ...
    function addSightingToDOM(sighting) {
        ...
        if (sighting.forwardedFrom) {
            ...
            fwdDiv.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 14 20 9 15 4"/><path d="M4 20v-7a4 4 0 0 1 4-4h12"/></svg> Weitergeleitet von ${sighting.forwardedFrom.groupName}`;
